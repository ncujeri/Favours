...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(LaxFavoursApp.config.endpoints);
    var serviceConfig = $.extend(true, {}, LaxFavoursApp.config.services, {
        db: {
    ...
    LaxFavoursApp.db = new DevExpress.data.ODataContext(serviceConfig.db);
